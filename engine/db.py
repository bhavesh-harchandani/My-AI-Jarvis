...
# print(results[0][0])
# contacts table banane ke liye naya code 
query = "CREATE TABLE IF NOT EXISTS contacts (id INTEGER PRIMARY KEY AUTOINCREMENT, NAME VARCHAR(100), phone VARCHAR(20))"
cursor.execute(query)
con.commit()
print("Table created successfully")
# 1. Pehle check karein aur web_command table banayein
...
con.commit()
print("web_command table successfully ban gaya!")

# 2. Ab default web commands insert karein
try:
    cursor.execute("INSERT INTO web_command VALUES (null, 'youtube', 'https://www.youtube.com/')")
    cursor.execute("INSERT INTO web_command VALUES (null, 'google', 'https://www.google.com/')")
    con.commit()
    print("Default web commands insert ho gayi hain!")
except Exception as e:
    print("Data insert karne me dikkat aayi:", e)
